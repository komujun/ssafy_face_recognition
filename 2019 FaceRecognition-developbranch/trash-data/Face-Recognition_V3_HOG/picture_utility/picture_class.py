class picture_data:
    ...
    def setPictureIdData(self, data):
        self.picture_id_data.append(data)
    ...
    def ResetPictureId(self, x, data):
    ...
    def getPictureIdData(self, x):
        return self.picture_id_data[x]
